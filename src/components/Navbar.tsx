  ...
  return (
    <header className="border-b border-tide-900/10 bg-paper/95 backdrop-blur sticky top-0 z-10">
      <div className="max-w-5xl mx-auto px-5 py-4 flex items-center justify-between">
        <Link to="/" className="font-display text-2xl font-semibold text-tide-900">
          Kadal Fresh
        </Link>
        <nav className="flex items-center gap-6 text-sm font-medium">
          ...
          <Link to="/cart" className="hover:text-catch-dark transition-colors relative">
            Cart
            {count > 0 && (
          ...
          <Link to="/admin" className="text-tide-400 hover:text-tide-900 transition-colors">
            Shop login
          </Link>
        </nav>
      </div>
