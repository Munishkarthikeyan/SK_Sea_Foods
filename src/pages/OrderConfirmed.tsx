...
export default function OrderConfirmed() {
  return (
    <main className="max-w-lg mx-auto px-5 py-20 text-center">
      <p className="text-xs uppercase tracking-wide text-catch-dark font-medium mb-2">
        Order placed
      </p>
      <h1 className="font-display text-2xl font-semibold mb-4">Thanks — we've got your order</h1>
